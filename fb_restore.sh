#!/bin/bash
	...
	SCRIPT_BKP="pharmacie.sh"		# Nome do script gerador dos arquivos de backups
	ORIGEM_BKP=/mnt/backups/pharmacie	# Pasta "raiz" onde há subpastas p/ cada banco de dados
	DESTINO_BKP=/home/firebird/databases	# Pasta onde será criado o arquivo do banco de dados restaurado
